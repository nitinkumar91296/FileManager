...
public class InitiateDatabase implements ApplicationRunner{
	...
	public void run(ApplicationArguments arg0) throws Exception {
		...
		if(!userService.existsByEmail("nitinkumar91296@gmail.com")) {
			
			new File("/Home/Nitin/CloudStore").mkdirs();
			Set<String> privileges = privilegeService.initiatePrivileges();
			Role role = roleService.createNewRole("ROLE_SUPER_ADMIN", privileges);
			userService.createSuperUser("nitinkumar91296@gmail.com","Nitin@91296",role);
			userDetailsService.addSuperUserDetails("nitinkumar91296@gmail.com");
